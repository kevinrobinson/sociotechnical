...
### Methodology issues encoded in the Boston housing dataset


~~~~~~~~~~~~~~~~


Got it.  Yeah FWIW, here's I guess a draft blog post :)  

But here's a more holistic response, framed as a comment on https://github.com/scikit-learn/scikit-learn/issues/16155#issuecomment-615347694.  I'm not sure if this repo, scikit-learn, fairlearn, or other places are interested in these directions.  But perhaps at the least adding a comment will give other curious folks places to start exploring :)

---

Hi folks!  I am late to notice this, but discovered this issue in a related discussion and thought it might be helpful to share some other background.  I'm doing this is a spirit of "other people thinking about this might find this data interesting" rather than "I hope this influences your decisions."  I have no real particular expertise here, but thought it might be worth sharing the little bits I have learned.  I am not planning on discussing further, and don't want to hijack this thread either :)
...
blog post: boston housing dataset
- year after cramer et al. (2019)

talk for fairlearn:
- build the infrastructure for impacting practioners
- HCI on one side
1 framing and translation
2 community
3 sociotechnical tools
